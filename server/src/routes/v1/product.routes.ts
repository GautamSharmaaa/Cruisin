...
productRouter.put('/:id', requireAuth, requireAdmin, requireRole(['manager', 'admin', 'superadmin']), validate({ params: idParamSchema, body: productUpdateSchema }), ProductController.update);
