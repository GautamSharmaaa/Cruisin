...
adminLogisticsRouter.post('/:shipmentId/assign-awb', requireRole(['admin', 'superadmin']), validate({ params: shipmentIdParamSchema, body: courierSelectionSchema }), LogisticsController.assignAwb);
adminLogisticsRouter.post('/:shipmentId/schedule-pickup', requireRole(['admin', 'superadmin']), validate({ params: shipmentIdParamSchema }), LogisticsController.schedulePickup);
adminLogisticsRouter.post('/:shipmentId/label', requireRole(['admin', 'superadmin']), validate({ params: shipmentIdParamSchema }), LogisticsController.document('label'));
adminLogisticsRouter.post('/:shipmentId/invoice', requireRole(['admin', 'superadmin']), validate({ params: shipmentIdParamSchema }), LogisticsController.document('invoice'));
adminLogisticsRouter.post('/:shipmentId/manifest', requireRole(['admin', 'superadmin']), validate({ params: shipmentIdParamSchema }), LogisticsController.document('manifest'));
...
adminLogisticsRouter.post('/:shipmentId/cancel', requireRole(['admin', 'superadmin']), validate({ params: shipmentIdParamSchema }), LogisticsController.cancel);
