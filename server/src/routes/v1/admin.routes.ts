...
adminRouter.patch('/orders/:id/status', validate({ params: idParamSchema, body: orderStatusSchema }), OrderController.updateStatus);
adminRouter.post('/orders/:id/mark-cod-paid', validate({ params: idParamSchema }), OrderController.markCodPaid);
adminRouter.post('/orders/:id/mark-partial-paid', validate({ params: idParamSchema }), OrderController.markPartialPaid);
adminRouter.post('/orders/:id/refund', validate({ params: idParamSchema, body: refundSchema }), PaymentController.refund);
