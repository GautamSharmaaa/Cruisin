...
adminRouter.get('/analytics/profitability', AdminController.profitabilityAnalytics);
adminRouter.get('/analytics/product-costs', requireRole(['admin', 'superadmin']), AdminController.productCostRows);
