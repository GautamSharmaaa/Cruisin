...
const shipmentSchema = new Schema({
  ...
  providerBilledFreightCost: { type: Number, min: 0 },
  providerBilledCodCharge: { type: Number, min: 0 },
  providerBilledOtherCharges: { type: Number, min: 0 },
  providerBilledRtoCost: { type: Number, min: 0 },
  providerBilledTotal: { type: Number, min: 0 },
  providerBillingStatus: { type: String, enum: ['unavailable', 'current'], default: 'unavailable', index: true },
  providerBillingSource: { type: String, enum: ['statement'] },
  providerBillingSyncedAt: { type: Date },
