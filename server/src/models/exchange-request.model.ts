...
const exchangeRequestSchema = new Schema({
  ...
  status: { type: String, enum: ['requested', 'approved', 'rejected', 'inventory_reserved', 'reverse_pickup', 'in_transit', 'warehouse_received', 'quality_check_passed', 'quality_check_failed', 'replacement_pending', 'replacement_shipped', 'completed', 'closed'], default: 'requested', index: true },
