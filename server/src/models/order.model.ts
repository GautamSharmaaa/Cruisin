...
const itemSchema = new Schema(
  {
    ...
    gstPercent: { type: Number, min: 0, default: 5 },
...
const orderSchema = new Schema(
  {
    ...
    paymentStatus: { type: String, enum: ['pending', 'authorized', 'paid', 'failed', 'partially_paid', 'cod_pending', 'cod_collected', 'refunded', 'partially_refunded', 'cancelled'], default: 'pending', index: true },
