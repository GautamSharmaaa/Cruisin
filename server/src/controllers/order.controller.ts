...
export const OrderController = {
  ...
  byId: asyncHandler(async (req: Request, res: Response): Promise<void> => { const order = await OrderService.byId(String(req.params.id ?? '')); res.json(new ApiResponse(order, 'Order loaded')); }),
