...
export default function CheckoutPage(): ReactNode {
  ...
  const orderTotal = useCartStore((state) => {
    ...
    const shipping = calculateShippingCharge(discountedSubtotal, state.freeShipping, selectedShipping);
