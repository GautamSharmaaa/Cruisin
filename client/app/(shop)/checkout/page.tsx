...
import { DeliveryServiceability } from '@/components/checkout/delivery-serviceability';
...
export default function CheckoutPage(): ReactNode {
  ...
  const orderTotal = taxInclusiveCheckoutTotals(subtotal, couponDiscount, shipping).total;
