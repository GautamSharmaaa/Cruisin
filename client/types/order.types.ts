...
export interface Order { id: string; status: string; paymentStatus: string; total: number; createdAt: string; trackingNumber?: string; items: OrderItem[]; timeline: Array<{ status: string; timestamp: string; note: string }>; }
