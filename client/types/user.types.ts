...
export interface User { id: string; name: string; email: string; role: 'customer' | 'admin' | 'superadmin' | 'manager' | 'viewer'; avatar?: string; phone?: string; isVerified: boolean; addresses?: SavedAddress[]; }
