...
export function Topbar({ onMenu }: TopbarProps): ReactNode {
  ...
  const showShiprocketSync = pathname === '/logistics' || pathname === '/analytics/costs';
