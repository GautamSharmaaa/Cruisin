...
import { BadgePercent, Clock3, Flame, Grid2X2, Images, LayoutTemplate, Mail, Megaphone, MessageSquareQuote, MonitorPlay, Newspaper, PackageSearch, Play, Rows3, Shirt, ShoppingBag, Sparkles, Star, Timer, Trophy, Users } from 'lucide-react';
